...
if( function_exists('acf_add_local_field_group') ):
	...
	acf_add_local_field_group(array(
		'key' => 'group_5fdf0f2e47b22',
		'title' => 'Theme Options',
		'fields' => array(
			array(
				'key' => 'field_5fdf11a833035',
				'label' => 'Kontakt',
				'name' => '',
				'type' => 'tab',
				'instructions' => '',
			...
			array(
				'key' => 'field_5fdf11bd33036',
				'label' => 'Sted Navn',
				'name' => 'sted_navn',
				'type' => 'text',
				'instructions' => 'Den bliver vist i kontakt boksen',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf1292e9127',
				'label' => 'Google 360 eller YouTube',
				'name' => 'google_360_eller_youtube',
				'type' => 'text',
				'instructions' => 'iframe med width=100%',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf12c4e912b',
				'label' => 'Google Map Marker',
				'name' => 'google_map_marker',
				'type' => 'textarea',
				'instructions' => 'fx:
	Lyren 6, Padborg',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf135d3e128',
				'label' => 'Hvor mange nyheder skal vi vise i oversigtsiden?',
				'name' => 'hvor_mange_nyheder_skal_vi_vise_i_oversigtsiden',
				'type' => 'text',
				'instructions' => 'fx: 10',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf13723e129',
				'label' => 'Skal nyhedsboksen vises i den højre kolonne?',
				'name' => 'skal_nyhedsboksen_vises_i_den_hojre_kolonne',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf13a43e12a',
				'label' => 'Skal nyhedsboksen vises på forsiden?',
				'name' => 'skal_nyhedsboksen_vises_pa_forsiden',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf144cfc500',
				'label' => 'Skal booking boksen være tilgængelig?',
				'name' => 'skal_booking_boksen_vaere_tilgaengelig',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf1646b8808',
				'label' => 'Facebook',
				'name' => 'facebook',
				'type' => 'text',
				'instructions' => 'URL med http://',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf165eb8809',
				'label' => 'Vis Facebook Nyhedsboksen i højre kolonne',
				'name' => 'vis_facebook_nyhedsboksen_i_hojre_kolonne',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf1680b880a',
				'label' => 'Vis Facebook Nyhedsboksen midt på forsiden',
				'name' => 'vis_facebook_nyhedsboksen_midt_pa_forsiden',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf1695b880b',
				'label' => 'Skal Facebook posts vises?',
				'name' => 'skal_facebook_posts_vises',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf170ea5e1f',
				'label' => 'Er din vandrerhjem kursus certificeret?',
				'name' => 'er_din_vandrerhjem_kursus_certificeret',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf1727a5e20',
				'label' => 'Er din vandrerhjem Nem Adgang certificeret?',
				'name' => 'er_din_vandrerhjem_nem_adgang_certificeret',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf1742a5e21',
				'label' => 'Find smiley link',
				'name' => 'find_smiley_link',
				'type' => 'textarea',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf177d8f4fe',
				'label' => 'Rating ID',
				'name' => 'rating_id',
				'type' => 'text',
				'instructions' => 'F.eks: COPCITY',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf17908f4ff',
				'label' => 'Skal boksen med ratings vises på hjemmesiden?',
				'name' => 'skal_boksen_med_ratings_vises_pa_hjemmesiden',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf17a88f500',
				'label' => 'Skal boksen med ratings være små eller stor?',
				'name' => 'skal_boksen_med_ratings_vaere_sma_eller_stor',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf17c68f501',
				'label' => 'Danhostel profilside',
				'name' => 'danhostel_profilside',
				'type' => 'text',
				'instructions' => 'F.eks: http://www.danhostel.dk/hostel/danhostel-copenhagen-city',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf181f0a44a',
				'label' => 'Skal boksen med turist info vises på hjemmesiden?',
				'name' => 'skal_boksen_med_turist_info_vises_pa_hjemmesiden',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf184f0a44c',
				'label' => 'Turist Info URL',
				'name' => 'turist_info_url',
				'type' => 'text',
				'instructions' => 'fx: http://visitdanmark.dk',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf1885e7766',
				'label' => 'Danhostel Linksystem',
				'name' => '',
				'type' => 'tab',
				'instructions' => '',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf1897e7767',
				'label' => 'Danhostel Linksystem: Tekst Link 1',
				'name' => 'text1',
				'type' => 'text',
				'instructions' => 'fx: Danhostel Padborg',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf18abe7768',
				'label' => 'Danhostel Linksystem: URL Link 1',
				'name' => 'link1',
				'type' => 'text',
				'instructions' => 'fx: http://danhostelfrederikshavn.dk',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf18bbe7769',
				'label' => 'Danhostel Linksystem: Tekst Link 2',
				'name' => 'text2',
				'type' => 'text',
				'instructions' => 'fx: Danhostel Padborg',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf18cae776a',
				'label' => 'Danhostel Linksystem: URL Link 2',
				'name' => 'link2',
				'type' => 'text',
				'instructions' => 'fx: http://danhostelfrederikshavn.dk',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf18e0e776b',
				'label' => 'Danhostel Linksystem: Tekst Link 3',
				'name' => 'text3',
				'type' => 'text',
				'instructions' => 'fx: Danhostel Padborg',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf18eee776c',
				'label' => 'Danhostel Linksystem: URL Link 3',
				'name' => 'link3',
				'type' => 'text',
				'instructions' => 'fx: http://danhostelfrederikshavn.dk',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf193a70f84',
				'label' => 'Vis quick links på forsiden?',
				'name' => 'quicklinksforside',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf194d70f85',
				'label' => 'Vis quick links på alle sider?',
				'name' => 'quicklinksallesider',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5fdf196170f86',
				'label' => 'Quick link 1: tekst',
				'name' => 'ql_text1',
				'type' => 'text',
				'instructions' => 'fx: kontrol rapport',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf197070f87',
				'label' => 'Quick link 1: link',
				'name' => 'ql_link1',
				'type' => 'text',
				'instructions' => 'fx: http://kontrolrapport.dk',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf198170f88',
				'label' => 'Quick Link 2: tekst',
				'name' => 'ql_text2',
				'type' => 'text',
				'instructions' => 'fx: Kontrol rapport',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf19a170f8a',
				'label' => 'Quick Link 3: tekst',
				'name' => 'ql_text3',
				'type' => 'text',
				'instructions' => 'fx: Kontrol rapport',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf19aa70f8b',
				'label' => 'Qiuck Link 3: link',
				'name' => 'ql_link3',
				'type' => 'text',
				'instructions' => 'fx: http://kontrolrapport.dk',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf19b870f8c',
				'label' => 'Quick Link 4: tekst',
				'name' => 'ql_text4',
				'type' => 'text',
				'instructions' => 'fx: Kontrol rapport',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf19c970f8d',
				'label' => 'Quick Link 4: link',
				'name' => 'ql_link4',
				'type' => 'text',
				'instructions' => 'fx: http://kontrolrapport.dk',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf19d570f8e',
				'label' => 'Quick Link 5: tekst',
				'name' => 'ql_text5',
				'type' => 'text',
				'instructions' => 'fx: Kontrol rapport',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf19e370f8f',
				'label' => 'Quick Link 5: link',
				'name' => 'ql_link5',
				'type' => 'text',
				'instructions' => 'fx: http://kontrolrapport.dk',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf1a1891198',
				'label' => 'Ekstra Forretningsområde',
				'name' => '',
				'type' => 'tab',
				'instructions' => '',
				'required' => 0,
			...
			array(
				'key' => 'field_5fdf1a2991199',
				'label' => 'Licens',
				'name' => 'licensnogle',
				'type' => 'text',
				'instructions' => 'For at bruge Danhostels skabelon for flere forretningsområder du har brug for en licens nøgle.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_5fdf1a549119b',
				'label' => 'Logo Ekstra forretning',
			...
			array(
				'key' => 'field_5fdf1a649119c',
				'label' => 'Link',
				'name' => 'link_forretning',
				'type' => 'text',
				'instructions' => 'F.eks: http://www.danhostel.dk/',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				...
				'choices' => array(
					'Danhostel Blå' => 'Danhostel Blå',
					'Mødelokaler Blå' => 'Mødelokaler Blå',
					'Camping Grøn' => 'Camping Grøn',
					'Urban Rød' => 'Urban Rød',
					'City Sort' => 'City Sort',
					'Sunshine Gul' => 'Sunshine Gul',
				),
				'default_value' => false,
				'allow_null' => 0,
				'multiple' => 0,
			...
			array(
				'key' => 'field_5fe074f3c8b8f',
				'label' => 'Google Analytics Kode',
...
if( ! function_exists( 'qns_load_js' ) ) {
	function qns_load_js() {
		...
		if ( is_admin() ) {
			...
			wp_register_script( 'custom', get_template_directory_uri() . '/js/scripts.js', array( 'jquery' ), '1.1', true );
			wp_register_script( 'fancybox', get_template_directory_uri() . '/lightbox/js/jquery.fancybox.pack.js', array( 'jquery' ), false, true );
			wp_register_script( 'cookie', get_template_directory_uri() . '/js/jquery.cookie.js', array( 'jquery' ), '2.1', true );
			wp_enqueue_script( 'cookie', get_template_directory_uri() . '/js/jquery.cookie.js', array ( 'jquery' ), '2.1', true);
